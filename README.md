...
- **Eclipse IDE for Enterprise and Web Developers**: We will be using the latest Eclipse as our *integrated development environment* (IDE). Though you don't need an IDE to write code, an IDE provides several features that make rapid development (e.g. quickly writing and refactoring code) easier. We will be downloading Eclipse for Enterprise and Web Developers as it comes with preinstalled plug-ins we will be utilizing. 
...
Verify that it was installed by searing for "Eclipse" using your task-bar's search tool. It should be installed to C:\Users\<user name>\scoop\apps\eclipse-jee\current\eclipse.exe

![](./images/EclipseSearch.jpg)
...
1. Navigate to the [Eclipse Downloads page](https://www.eclipse.org/downloads/packages/) page and scroll down to Eclipse IDE for Enterprise Java and Web Developers. Then download the option for your operating system. (This should be Windows.) 

![](./images/EclipseDownload.jpg)

2. Once the download has finished go to your downloads folder, search for the eclipse-jee zip file and double click it to open it. Then click the "Extract all" button to open the extraction wizard. 

![](./images/EclipseZip.jpg)

3. You can browse for a location of your choosing to extract it too and then click "Extract." 

![](./images/EclipseExtract.jpg)

4. Once the install is complete you will have an eclipse folder in the directory you chose to install to. 

![](./images/EclipseFolder.jpg)

5. Once inside the folder you should have an eclipse.exe application if everything installed correctly. You can use this to add a shortcut to your desktop by right-clicking it selecting Send To > Desktop from the menu. 

![](./images/EclipseReady.jpg)
